          ...
          <div className="relative aspect-[4/3] w-full overflow-hidden rounded-sm bg-charcoal">
            <svg viewBox="0 0 400 300" className="h-full w-full" role="img" aria-label="Stylised map showing Um-Lilo's location in Woodstock, Cape Town">
              ...
              {[40, 100, 160, 220, 280, 340].map((x) => (
                <line key={`v${x}`} x1={x} y1="0" x2={x} y2="300" stroke="rgba(239,231,216,0.12)" strokeWidth="1" />
              ))}
              {[30, 90, 150, 210, 270].map((y) => (
                <line key={`h${y}`} x1="0" y1={y} x2="400" y2={y} stroke="rgba(239,231,216,0.12)" strokeWidth="1" />
              ))}
              <line x1="0" y1="150" x2="400" y2="150" stroke="rgba(239,231,216,0.3)" strokeWidth="2" />
              <line x1="200" y1="0" x2="200" y2="300" stroke="rgba(239,231,216,0.3)" strokeWidth="2" />
              ...
              <text x="14" y="145" fill="rgba(239,231,216,0.4)" fontSize="9" fontFamily="var(--font-sans)" letterSpacing="2">
                ALBERT RD
              </text>
              <text x="206" y="20" fill="rgba(239,231,216,0.4)" fontSize="9" fontFamily="var(--font-sans)" letterSpacing="2">
                WOODSTOCK
              </text>
            </svg>
          </div>
